...
if(NOT WIN32)
    if(ENABLE_OPENCV_VIDEOIO)
        set(OpenCV_LIBS opencv_core opencv_imgproc opencv_imgcodecs opencv_video opencv_videoio opencv_highgui)
    else()
        set(OpenCV_LIBS opencv_core opencv_imgproc opencv_imgcodecs opencv_highgui) # no videoio, video module
    endif()
else()
